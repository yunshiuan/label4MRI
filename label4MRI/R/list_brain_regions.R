#' @title List all brain region names in AAL/BA system.
#' @description Input template names, output all the brain region names.
...
#' @return Return a list of charcter vectors.
...
#' @export
 ...
 list_brain_regions <- function(template = c("aal", "ba")) {
    lapply(setNames(template,template),
           function(.template){
